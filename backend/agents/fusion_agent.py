...
════════════════════════════════
STUDENT LEARNING PROFILE (adapt tone/depth/examples to this):
{{$student_context}}
...
class FusionAgent:
    def __init__(self, kernel: Kernel):
        ...
        self._mutate_fn = _make_fn("mutate", MUTATION_PROMPT,           ["note_page", "doubt", "slide_context", "textbook_context", "student_context"])
